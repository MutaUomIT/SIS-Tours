  ...
  public static activityList = [
    ...
    },
    {
      ...
      "dayWiseActivities":[
        {
          "day":'1',
          "dailyActivities":["Pick up from air port","Breakfast on the Negambo beach","Lagoon, beach and sight seens","Dinner"]
        },
        {
          "day":'2',
          "dailyActivities":["Whale watching","Breakfast","Checkout the hotel","Lunch","Evening safari"]
        },
        {
          "day":'3',
        ...
        {
          "day":'5',
          "dailyActivities":["Breakfast","Check out","Peradeniya botanical gardens","Pinnawala elephant orphanage","Lunch at Pinnawala","Lunch at Pinnawala","Check in to hotel in Negambo","Dinner and night out in a club","Dambulla golden cave temple","Check in to hotel in Sigiriya","Dinner"]
        },
        {
          "day":'6',
          "dailyActivities":["Breakfast","Check out – depending on the time of the air flight","Shopping and city tour",
            "Lunch and Dinner depending on the flight schedule","Air Port Drop"]
        }
      ]
    },
    {
      ...
      "dayWiseActivities":[
        {
          "day":'1',
          "dailyActivities":["Pick up from air port","Breakfast on the Negambo beach","Pinnawala Elephant Orphanage","Lunch after Pinnawala Orphanage",
            "Check in to the hotel in Kandy","Cultural Show","Dinner"]
        },
        {
          "day":'2',
        ...
        },
        {
          ...
          "day":'3',
          "dailyActivities":["Breakfast at hotel","Checkout to Nuwaraeliya","Tea factory visit","Sight seen and waterfalls",
            "Check in to hotel at Nuwaraeliya","Lunch at the Hotel",
            "Visit Gregory’s lake and Victoria park","Dinner"]
        },
        {
          "day":'4',
          "dailyActivities":["Breakfast at hotel","Climb Piduruthalagala","Visit moon Plains","Lunch at hotel","Spa treatment","Dinner"]
        },
        {
      ...
      "dayWiseActivities":[
        {
          "day":'1',
          "dailyActivities":["Pick up from air port","Breakfast on the Negambo beach","Pinnawala Elephant Orphanage","Lunch after Pinnawala Orphanage",
            "Check in to the hotel in Kandy","Dinner"]
        },
        {
          "day":'2',
          "dailyActivities":["Breakfast","Kandy Tooth Relic Temple, City Tour","Lunch at the hotel and checkout",
            "Tea Factory vist","Check in to the hotel in Nuwaraeliya","Visit to Victoria Park and Gregory’s Lake","Dinner"]
        },
        {
          "day":'3',
        ...
        {
          "day":'4',
          "dailyActivities":["Breakfast","Climb Piduruthalagala","hecking out Hotel and visit Haggala gardens",
            "leaving to Yala","Lunch on the way","Checking in to Yala Hotel","BBQ Dinner"]
        },
        {
          "day":'5',
        ...
        {
          "day":'6',
          "dailyActivities":["Whale Watching","Breakfast","Check out","Lunch in Hikkaduwa","Leaving to Colombo",
            "Check in to Colombo Hotel","City Tour","Night out at a club or Dinner"]
        },
        {
          "day":'7',
